...
public abstract class FieldEditorOverlayPage extends FieldEditorPreferencePage implements IWorkbenchPropertyPage {
	...
	private void createSelectionGroup(Composite parent) {
		...
		useWorkspaceSettingsButton = createRadioButton(radioGroup, "Use Atomic preferences"); //$NON-NLS-1$
		useProjectSettingsButton = createRadioButton(radioGroup, "Use custom project settings"); //$NON-NLS-1$
		configureButton = new Button(comp, SWT.PUSH);
		configureButton.setText("Configure Atomic preferences"); //$NON-NLS-1$
