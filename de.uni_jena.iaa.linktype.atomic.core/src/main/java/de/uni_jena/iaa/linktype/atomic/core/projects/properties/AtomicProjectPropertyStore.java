...
/**
 * An overlay property store for resource-specific properties which are tied to
 * application preferences (i.e., the workbench preference store).
 * 
	...
	private void writeProperties() throws IOException {
		...
		for (int i = 0; i < preferences.length; i++) {
			...
			try {
				...
				throw new IOException("Cannot write resource property"); //$NON-NLS-1$
			}
		}
	}
