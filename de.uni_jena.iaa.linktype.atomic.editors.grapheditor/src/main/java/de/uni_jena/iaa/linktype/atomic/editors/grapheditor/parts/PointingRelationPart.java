 ...
 *
 */
public class PointingRelationPart extends AbstractConnectionEditPart {

	private PointingRelationAdapter adapter;

	public PointingRelationPart() {
		super();
		setAdapter(new PointingRelationAdapter());
	}
	...
	protected IFigure createFigure() {
		return new RelationFigure(PartUtils.getVisualID(getModel()), RelationFigure.POINTINGRELATION_MODEL);
	}
	...
	public SPointingRelation getModel() {
		return (SPointingRelation) super.getModel();
	}

	/**
	 * @return the adapter
	 */
	public PointingRelationAdapter getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(PointingRelationAdapter adapter) {
	 ...
	 *
	 */
	public class PointingRelationAdapter extends EContentAdapter {
