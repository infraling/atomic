 ...
 *
 */
public class AtomicMavenAccessor extends MavenAccessor {

	/**
	 * @param pepperOSGiConnector
	 */
	public AtomicMavenAccessor(PepperOSGiConnector pepperOSGiConnector) {
		super(pepperOSGiConnector);
