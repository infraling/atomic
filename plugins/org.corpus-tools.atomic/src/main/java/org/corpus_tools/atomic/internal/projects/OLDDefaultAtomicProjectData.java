...
/**
 * This internal class is the default implementation of {@link AtomicProjectData}. It is not API and will only be used internally.
 * <p>
 ...
 *
 */
public class OLDDefaultAtomicProjectData implements AtomicProjectData {
	 ...
	 */
	public OLDDefaultAtomicProjectData(String projectName) {
		this.projectName  = projectName;
	}

	/**
	 * Defines a static logger variable so that it references the {@link org.apache.logging.log4j.Logger} instance named "OLDDefaultAtomicProjectData".
	 */
	private static final Logger log = LogManager.getLogger(OLDDefaultAtomicProjectData.class);
	...
	/* 
	 * @copydoc @see org.corpus_tools.atomic.projects.AtomicProjectData#createDocumentAndAddToCorpus(java.lang.String, java.lang.String, java.lang.String)
	 */
	public void createDocumentAndAddToCorpus(String corpusName, String documentName, String documentSourceText) {
		...
		if (getCorpora().containsKey(corpusName)) {
			...
			Iterator<Pair<String, String>> corpusIterator = corpus.iterator();
