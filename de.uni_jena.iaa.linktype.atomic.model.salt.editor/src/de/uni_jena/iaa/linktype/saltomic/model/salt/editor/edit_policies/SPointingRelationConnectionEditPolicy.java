 ...
 *
 */
public class SPointingRelationConnectionEditPolicy extends ConnectionEditPolicy {
	...
	protected Command getDeleteCommand(GroupRequest request) {
		SPointingRelationDeleteCommand command = new SPointingRelationDeleteCommand();
		command.setSPointingRelation((SPointingRelation) getHost().getModel());
		return command;
	}
