 ...
 *
 */
public class SDominanceRelationAnnotateCommand extends Command {
	
	private SDominanceRelation model;
	private List<SAnnotation> oldAnnotations = new ArrayList<SAnnotation>();
...
//	@Override 
//	public void undo() {
//		if (model.getSAnnotation("ATOMIC__PRIMARY_ANNOTATION") == null)
...
//	}
	...
	public void setModel(SDominanceRelation model) {
		this.model = model;
	}
