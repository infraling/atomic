 ...
 *
 */
public class SStructureGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionCompleteCommand(CreateConnectionRequest request) {
		...
		if (request.getStartCommand() instanceof SPointingRelationCreateCommand) {
		    ...
		    sPointingRelationResult.setTarget((SStructure) getHost().getModel());
		    ...
		    sDominanceRelationResult.setTarget((SStructure) getHost().getModel());
	...
	protected Command getConnectionCreateCommand(CreateConnectionRequest request) {
		...
		if (request.getNewObject() instanceof SPointingRelation) {
		    ...
		    sPointingRelationResult.setSource((SStructure) getHost().getModel());
		    sPointingRelationResult.setSPointingRelation((SPointingRelation) request.getNewObject());
		    sPointingRelationResult.setGraph(((SStructure) getHost().getModel()).getSDocumentGraph());
		    ...
		    sDominanceRelationResult.setSource((SStructure) getHost().getModel());
		    sDominanceRelationResult.setSDominanceRelation((SDominanceRelation) request.getNewObject());
		    sDominanceRelationResult.setGraph(((SStructure) getHost().getModel()).getSDocumentGraph());
