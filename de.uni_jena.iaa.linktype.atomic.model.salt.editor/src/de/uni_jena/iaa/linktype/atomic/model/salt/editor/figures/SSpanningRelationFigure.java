 ...
 *
 */
public class SSpanningRelationFigure extends PolylineConnection {
	
	private String iDLabelString;
	private IDLabel iDLabel;

	public SSpanningRelationFigure(String labelString) {
		this.iDLabelString = labelString;
		setForegroundColor(ColorConstants.orange);
		PolygonDecoration decoration = new PolygonDecoration();
		decoration.setTemplate(PolygonDecoration.TRIANGLE_TIP);
		setTargetDecoration(decoration);
		iDLabel = new IDLabel(iDLabelString, "SSPANNINGRELATION");
