 ...
 *
 */
public class SDominanceRelationConnectionEditPolicy extends
	...
	protected Command getDeleteCommand(GroupRequest request) {
		SDominanceRelationDeleteCommand command = new SDominanceRelationDeleteCommand();
		command.setSDominanceRelation((SDominanceRelation) getHost().getModel());
		return command;
	}
